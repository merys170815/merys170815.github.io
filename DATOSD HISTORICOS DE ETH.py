...
# Símbolo del par de trading (por ejemplo, ETHUSDT)
symbol = 'ETHUSDT'
...
# Guardar los datos en el mismo archivo CSV
df.to_csv('datos_historicos_binance.csv', mode='a', header=False, index=False)

print('Datos históricos de ETH agregados al archivo datos_historicos_binance.csv')
